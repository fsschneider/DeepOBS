...
# -*- coding: utf-8 -*-
"""
Run tensorflow-s SGD Optimizer on a DeepOBS test problem.

Usage:

    python run_sgd.py <dataset>.<problem> --all_the_command_line_arguments

Execute python run_sgd.py --help to see a description for the command line
arguments.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run SGD on a DeepOBS test problem.")
...
def main(test_problem, bs, lr, N, data_dir=None, wd=None, lr_sched_epochs=None, lr_sched_factors=None, checkpoint_epochs=1, random_seed=42, nologs=False, train_log_interval=10, print_train_iter=False, saveto="results", pickle=False, no_time=False, run_name=""):
