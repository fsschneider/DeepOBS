# -*- coding: utf-8 -*-
"""Tests for the VGG16 architecture on the CIFAR-10 dataset."""
...
class Cifar10_VGG16Test(unittest.TestCase):
    """Test for the VGG16 architecture on the CIFAR-10 dataset."""
        ...
        with tf.Session() as sess:
            ...
            for init_op in [
                ...
                losses_, regularizer_, accuracy_ = sess.run(
                    [
                        self.cifar10_vgg16.losses,
                        self.cifar10_vgg16.regularizer,
