...
class data_loading:
    ...
    def train_dataset(self, batch_size, data_augmentation=True):
        """Create a ``tf.data.Dataset`` for the SVHN training data."""
    ...
    def train_eval_dataset(self, batch_size, data_augmentation=True):
        """Create a ``tf.data.Dataset`` for the SVHN training evaluation data."""
    ...
    def test_dataset(self, batch_size):
        """Create a ``tf.data.Dataset`` for the SVHN test data."""
