...
class set_up:
    ...
    def _batch_norm(self, x, phase, decay=0.9, name="batch_norm"):
        ...
        Apply batch normalization to tensor x, switching between train and evaluation
        mode depending on the value of the placeholder phase ("train", "train_eval",
        "test").
        """
    ...
    def _conv(self, x, filter_size, out_channels, stride, padding="SAME", name="conv"):
        ...
        as specified. The kernel is created/retrieved via tf.get_variable. No bias is
        added and no non-linearity is applied."""
