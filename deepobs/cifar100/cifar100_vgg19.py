...
class set_up:
    """Class providing the functionality for the VGG 19 architecture on `CIFAR-100`. The `CIFAR-100` images are resized to ``224`` by ``224`` to fit the input dimension of the original VGG network, which was designed for `ImageNet`.
