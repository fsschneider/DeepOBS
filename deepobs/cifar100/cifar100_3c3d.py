...
class set_up:
    """Class providing the functionality for a vanilla CNN architecture on `CIFAR-100`.
    ...
    def set_up(self, weight_decay):
        ...
        W_conv1 = self.conv_filter("W_conv1", [5, 5, 3, 64])
        ...
        W_conv2 = self.conv_filter("W_conv2", [3, 3, 64, 96])
        ...
        W_conv3 = self.conv_filter("W_conv3", [3, 3, 96, 128])
        ...
        b_fc3 = self.bias_variable("b_fc3", [100], init_val=0.0)
