...
class mnist(dataset.DataSet):
  ...
  """
    ...
    def _make_dataloader(self, train, shuffle = True, sampler = None):
        ...
        loader = dat.DataLoader(dataset, batch_size=self._batch_size, shuffle=shuffle, sampler=sampler, drop_last=True, pin_memory=self._pin_memory, num_workers=self._num_workers)
        return loader
