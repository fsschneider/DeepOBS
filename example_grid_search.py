...
tuner = GridSearch(optimizer_class, hyperparams, grid, ressources=6*3*2)
...
tuner.generate_commands_script('quadratic_deep', num_epochs =2, output_dir='./grid_search', generation_dir='./grid_search_commands')